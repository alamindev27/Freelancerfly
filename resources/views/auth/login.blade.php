                                ...
                                <div class="twm-log-reg-inner">
                                    ...
                                    <div class="twm-tabs-style-2">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                            <li class="nav-item">
                                                <button onclick="window.location.href='{{ route('login') }}'" class="nav-link active"><i class="fas fa-user-tie me-2"></i>Login</button>
                                            </li>
                                            <li class="nav-item">
                                                <button onclick="window.location.href='{{ route('register') }}'" class="nav-link"><i class="fas fa-building me-2"></i>Sign Up</button>
                                            </li>
                                        </ul>
                                                            ...
                                                            <div class="twm-forgot-wrap">
                                                                <div class="form-group mb-3">
                                                                    <div class="form-check">
                                                                        ...
                                                                        <label class="form-check-label rem-forgot" for="remember">Remember me <a href="{{ route('password.request') }}" class="site-text-primary">Forgot Password</a></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
