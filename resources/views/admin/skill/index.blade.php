...
@section('content')
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Skill List</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('skill.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Create Skill</a>
                        </div>
                    </div>
                    <div class="card-body">
                          ...
                          <tbody>
                            @foreach ($skills as $skill)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $skill->slug }}</td>
                                    <td class="align-middle">
                                        <form action="{{ route('skill.destroy', $skill->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                            <a href="{{ route('skill.edit', $skill->id) }}" class="text-info"><i class="fas fa-edit"></i></a>
