...
@section('content')
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Social List</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('social.create') }}" class="btn btn-success btn-sm"><i class="fas fa-plus"></i> Create Social</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            @foreach ($socials as $data)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href="{{ $data->link }}">
                                            <img src="{{ asset($data->logo) }}" alt="{{ $data->name }}" width="60" class="border p-1 rounded">
                                        </a>
                                    </td>
                                    <td class="align-middle">
                                        ...
                                        @csrf
                                        @method('DELETE')
                                            <a href="{{ route('social.edit', $data->id) }}" class="text-info"><i class="fas fa-edit"></i></a>
