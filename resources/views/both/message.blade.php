                                    ...
                                    <div class="panel-body wt-panel-body p-a20 m-b30 ">
                                        <div class="wt-admin-dashboard-msg-2">
                                            ...
                                            <div class="wt-dashboard-msg-user-list">
                                                ...
                                                <div class="wt-dashboard-msg-search">
                                                    <div class="input-group">
                                                        ...
                                                        <button class="btn" type="button"><svg
                                                            ...
                                                            </svg><!-- <i class="fa fa-search"></i> Font Awesome fontawesome.com --></button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="scroll-wrapper wt-dashboard-msg-search-list scrollbar-macosx"
                                                    style="position: relative;">
                                                    <div class="wt-dashboard-msg-search-list scrollbar-macosx scroll-content"
                                                        id="conversation_list"
                                                        style="position: relative; height: 700px; margin-bottom: 0px; margin-right: 0px; max-height: none;">
                                                        <div class="wt-dashboard-msg-search-list-wrap">
                                                            <a href="javascript:void(0)"
                                                                class="msg-user-info clearfix conversation_21587 active_conversation"
                                                                conversation_id="21587">
                                                                <div class="msg-user-timing"></div>
                                                                <div class="msg-user-info-pic"><img
                                                                        src="https://gpsfreelancer.com/default/profile.jpg"
                                                                        alt=""></div>
                                                                <div class="msg-user-info-text">
                                                                    <div class="msg-user-name"> Md Shuvo Khan</div>
                                                                    <div class="msg-user-discription  text-muted">Hi</div>
                                                                </div>
                                                            </a>
                                                        </div>
                                            ...
                                            <div id="msg-chat-wrap" class="wt-dashboard-msg-box">
                                                <div class="single-msg-user-name-box">
                                                    <div class="single-msg-short-discription">
                                                        <h4 class="single-msg-user-name">Md Shuvo Khan
                                                            <p>Expert Web Designer with Ajax experience</p>
                                                        </h4>
                                                    </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="single-user-comment-block clearfix">
                                                                    <div class="single-user-com-pic"><img
                                                                            src="https://gpsfreelancer.com/default/profile.jpg"
                                                                            alt=""></div>
                                                                    <div class="single-user-com-text">Hi</div>

                                                                    <div class="single-user-msg-time"><svg style="width: 20px"
                                                                            class="svg-inline--fa fa-check text-wright"
                                                                            style="font-size: 10px;" aria-hidden="true"
                                                                        ...
                                                                        </svg><!-- <i class="fa fa-check text-wright" style="font-size: 10px"></i> Font Awesome fontawesome.com -->
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="single-msg-reply-comment">
                                                    ...
                                                    <div class="publisher bt-1 border-light w-100">
                                                        <span class="user-icon"><svg class="svg-inline--fa fa-user"
                                                                aria-hidden="true" focusable="false" data-prefix="fas"
                                                            ...
                                                            </svg><!-- <i class="fa-solid fa-user"></i> Font Awesome fontawesome.com --></span>

                                                        <form action="https://gpsfreelancer.com/send/message"
                                                            id="conversation_form" method="post" class="w-100">
                                                            <input class="publisher-input message" type="text"
                                                                name="message" placeholder="Write something"
                                                                style="width: 93%">
                                                            <input type="hidden" name="conversation_id" value="21587">

                                                            <button type="submit" class="publisher-btn primary-btn-color"
                                                                id="send_message" data-abc="true"><svg
                                                                ...
                                                                </svg><!-- <i class="fa fa-paper-plane"></i> Font Awesome fontawesome.com --></button>
                                                        </form>
