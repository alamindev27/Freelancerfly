            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 rightSidebar"
                        style="position: relative; overflow: visible; box-sizing: border-box; min-height: 1628.5px;">
                        ...
                        <div class="theiaStickySidebar"
                            style="padding-top: 0px; padding-bottom: 1px; position: absolute; transform: translateY(695.219px); width: 525.984px; top: 0px;">
                            <div class="side-bar">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="dropdown bootstrap-select wt-select-bar-large filter_item"><select
                                                    ...
                                                    aria-haspopup="listbox" aria-expanded="false" title="All Category"
                                                    data-id="category">
                                                    <div class="filter-option">
                                                        <div class="filter-option-inner">
                                                            <div class="filter-option-inner-inner">All Category</div>
                                                        </div>
                                                    </div>
                                                </button>
